    ...
    <form class="form-horizontal" id="form1">
        <div class="box-body no-margin">
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="部门名称" value="生产部门">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" class="form-control" id="info" name="info" placeholder="部门信息" value="负责生产产品">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" class="form-control" id="phone"  name="phone" placeholder="联系方式" value="123456789">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="number" class="form-control" id="empCount" name="empCount" placeholder="员工数" value="0">
                </div>
            </div>
        </div>
        <!-- /.box-body -->
