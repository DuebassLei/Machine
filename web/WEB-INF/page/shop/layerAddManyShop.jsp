...
<div class="panel panel-default margin">
    <p class="lead">
        请按以下步骤执行
    <ol>
        <li>下载商品信息统一导入模板<a href="${pageContext.request.contextPath}/shop/downloadFile" class="btn-link"><h6>
            《商品信息导入_模板.xlsx》</h6>
        </a><br/></li>
        <li>将商品信息填入模板,上传提交。</li>
    </ol>
    </p>
</div>
...
<script>
    $(function () {
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '${pageContext.request.contextPath}/shop/uploadEmp',
            // 选择文件的按钮。可选。
