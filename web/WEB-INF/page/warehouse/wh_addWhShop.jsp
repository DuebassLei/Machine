    ...
    <form class="form-horizontal" id="form1">
        <div class="box-body no-margin">
            <div class="form-group">
                <label for="worehouseId" class="col-xs-2 control-label">
                    <i class="fa fa-hand-paper-o fa-2x"></i>
                </label>
                <div class="col-xs-10">
                    <input type="text" class="form-control" id="worehouseId" name="worehouseId" placeholder="仓库名称" value="20号仓库">
                </div>
            </div>
            <div class="form-group">
...
<script>
    $(function () {
        ...
        $("#btn_submit").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: '${pageContext.request.contextPath}/warehouse/addWhShop',
                data: data4Send,
